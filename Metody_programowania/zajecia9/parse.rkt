...
(define grammar
  `(("add-operator"
    ...
    ("expression"
     (("pow-expr" "pow-rest")
          ,(lambda (e1 f) (f e1)))
     (("unary-expr") ,(lambda (e) e)))

    ("pow-rest"
     (("mult-operator" "pow-expr" "pow-rest")
         ,(lambda (op e2 f) (lambda (e1)
                              (f (exp-op op e1 e2)))))
     (("add-operator" "pow-expr" "pow-rest")
         ,(lambda (op e2 f) (lambda (e1)
                              (f (exp-op op e1 e2)))))
     (() ,(lambda () (lambda (e) e))))
